...
# Imporing some other necessary libraries
import numpy as np
import pandas as pd

# importing functions for logging and exception handling
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            ## Categorical Pipeline (empty if no categorical columns)
            cat_pipeline = Pipeline(steps=[])
            
            # If you have categorical columns, uncomment the following lines and replace cat_col_1, cat_col_2 with actual column names.
    ...
    def initiate_data_transformation(self, train_data_path, test_data_path):
        ...
        ## Exception Block
            ...
            logging.info("Error in Data Transformation Step!")
            print(e)
            raise CustomException(e, sys)
#################################################################################################################